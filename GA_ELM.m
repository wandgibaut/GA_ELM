...
%    for i=1:n_times,
        ...
        [options numberOfVariables] = configureGA(lambda_0);
...
%        for j=1:length(c),
            ...
            % atencao pra esta parte. alterada para um vetor
...
%    end
    ...
    midFini=cputime;
    total_time=midFini-midIni;
    disp(['tempo total:' num2str(total_time)]);
